...
namespace IBM.WatsonDeveloperCloud.Discovery.v1
{
    public interface IDiscoveryService
    {
        ...
        /// <returns><see cref="Configuration2" />Configuration</returns>
        Configuration2 CreateConfiguration(string environmentId, Configuration2 configuration);
        ...
        /// <param name="configurationId">the ID of your configuration</param>
        /// <returns><see cref="Configuration2" />Configuration</returns>
        Configuration2 GetConfiguration(string environmentId, string configurationId);
        ...
        /// <returns><see cref="Configuration2" />Configuration</returns>
        Configuration2 UpdateConfiguration(string environmentId, string configurationId, Configuration2 configuration);
        /// <summary>
